...
NODE_CLASS_MAPPINGS = {
    ...
    "Seedvr_Upscaler_deepgen": SeedvrUpscalerNode,
    "Seedvr_Upscale_Video_deepgen": SeedvrUpscaleVideoNode,
    "Bria_Video_Increase_Resolution_deepgen": BriaVideoIncreaseResolutionNode,
    "Topaz_Upscale_Video_deepgen": TopazUpscaleVideoNode,
}

# Node display name mappings
NODE_DISPLAY_NAME_MAPPINGS = {
    "Upscaler_deepgen": "Clarity Upscaler (deepgen)",
    "Seedvr_Upscaler_deepgen": "Seedvr Upscaler (deepgen)",
    "Seedvr_Upscale_Video_deepgen": "Seedvr Upscale Video (deepgen)",
    "Bria_Video_Increase_Resolution_deepgen": "Bria Video Increase Resolution (deepgen)",
    "Topaz_Upscale_Video_deepgen": "Topaz Upscale Video (deepgen)",
}
